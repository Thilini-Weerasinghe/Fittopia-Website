<div class="block hero">
    <div class="grid-x hero__content">
        <div class="grid-x align-middle align-center cell small-12 medium-12 large-6 hero__main-content">
        ...
        <div class="cell small-12 medium-12 large-6 right-content">
            ...
            <div class="hero__slider__dots circle-slick-dots js-slider-dots"></div>
        </div>
    </div>
    <div class="scroll">
