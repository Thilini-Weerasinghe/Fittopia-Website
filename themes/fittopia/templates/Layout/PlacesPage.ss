...
<div class="search block " data-aos="flip-down">
    <div class="search__content">
        <div class="grid-container">
            ...
            <hr>
                <div class="grid-x align-center wrapper">
                    <div class="cell small-12 medium-12 large-12">
                        <h4> Search below to find the best health and fitness near you.</h4>
                    </div>
                    ...
                    <div class="cell small-12 medium-4 large-2">
                        <a href="#" class="button search-btn">search <i class="fas fa-long-arrow-alt-right"></i></a>
                    </div>
                </div>
        </div>
    </div>
